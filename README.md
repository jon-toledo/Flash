...
Standard practice amoung climbers is to use a guidebook or 'topo' in order to identify specific climbing routes when climbing outdoors.  This turns out to be much harder than one may naively expect.  Determining which route is which using the (often sparse) information of the guides is a hard problem!  When climbing in new areas, a great deal of valuable climbing time is lost on this task.  
